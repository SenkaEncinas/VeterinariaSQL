...
class MascotaRescatadaScreen extends StatefulWidget {
  ...
  @override
  State<MascotaRescatadaScreen> createState() => _MascotaRescatadaScreenState();
}
...
class _MascotaRescatadaScreenState extends State<MascotaRescatadaScreen> {
  ...
  void _registrarMascotaRescatada() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Mascota rescatada registrada exitosamente"),
